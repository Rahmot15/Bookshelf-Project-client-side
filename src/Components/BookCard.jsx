      ...
      <div className="relative px-6 pb-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-500">rating</span>
          </div>
          ...
          <div className="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 transition-colors duration-300">
            <BookOpen size={16} className="text-gray-600 dark:text-gray-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300" />
          </div>
        </div>
